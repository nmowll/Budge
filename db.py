...
local_connection_string = 'Driver={ODBC Driver 17 for SQL Server};Server=localhost;Database=Budge;Trusted_Connection=yes;TrustServerCertificate=yes;'
db_connection_string = 'Driver={ODBC Driver 17 for SQL Server};Server=tcp:'+server_name+',1433;Database='+db_name+';Uid='+username+';Pwd='+password+';Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;'
